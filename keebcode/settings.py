"""
Django settings for keebcode project.
...
WSGI_APPLICATION = 'keebcode.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'CLIENT': {
            'host': 'mongodb+srv://Ivan:' + MONGO_PRIVATE_KEY + '@cluster0.tpvhz.azure.mongodb.net/test',
            'username': 'Ivan',
